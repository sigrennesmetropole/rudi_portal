...
/**
 * Provoquée lorsque l'endpoint d'une API déclarée par le portail dans WSO2 renvoie une erreur.
 * L'erreur peut être observée dans l'application RUDI lorsqu'on tente de télécharger un média d'un jeu de données.
 *
 * <p>
 ...
 *
 * <ul>
 *     <li>Noter l'identifiant du média dont le téléchargement échoue (par exemple dans l'URL <code>/konsult/v1/datasets/e3218a63-e3c6-4a14-b276-43c8384dade3/media/84486a5a-2ec6-401a-b283-7bdddc6f4be2/download</code> l'identifiant du média est <code>84486a5a-2ec6-401a-b283-7bdddc6f4be2</code></li>
