...
/**
 * Lorsque cette erreur apparaît, on peut tenter de faire disparaître l'erreur en se connectant avec le login concerné sur les différentes
 * applications WSO2. Notamment :
 *
 * <ul>
...
public class BuildClientRegistrationException extends APIManagerException {
	...
	private static final long serialVersionUID = -7321347556395151916L;
