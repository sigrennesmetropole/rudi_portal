...
public interface ApplicationService {
	...
	/**
	 * Créer l'application RUDI (avec ses clés PRODUCTION ET SANDBOX) par défaut pour l'utilisateur ou la récupère si elle existe déjà.
	 */
	 ...
	 */
	Applications searchApplication(ApplicationSearchCriteria applicationSearchCriteria, String username)
	 ...
	 * @throws APIManagerException Erreur lors de la recherche
	 */
	SubscriptionList searchApplicationAPISubscriptions(
	 ...
	 */
	void createDefaultSubscriptions(String apiId, boolean isRestricted)
			throws APISubscriptionException, ApplicationOperationException;

	/**
	 * Suppression de toutes les souscriptions à une application (en vue d'une suppression de l'API par exemple) sans modifier le statut de l'API
	 * (contrairement à org.rudi.microservice.kalim.service.helper.apim.APIManagerHelper#retireAPIToDeleteAllSubscriptions)
	 *
	 * @param apiId Identifiant de l'API
	...
	/**
	 * Indique l'état de la souscription à une API par l'application par défaut de l'utilisateur
	 * 
	 * @param apiId
	 * @param username
	 * @return l'état
	 * @throws APIManagerException
	 */
	HasSubscriptionStatus hasSubscribeAPIToDefaultUserApplication(String apiId, String username)
			throws APIManagerException;

	/**
	 * Indique l'état de la souscription à une API par une application d'un utilisateur
	 *
	 * @param apiId         identifiant de l'api
	 * @param applicationId identifiant de l'application
	 * @param username      username de l'utilisateur
	 ...
	 */
	HasSubscriptionStatus hasSubscribeAPI(String apiId, String applicationId, String username)
			throws APIManagerException;
	 ...
	 */
	Subscription updateSubscriptionAPI(Subscription applicationAPISubscription, String username)
			throws APIManagerException;
	 ...
	 */
	DocumentContent downloadAPIContent(UUID globalId, UUID mediaId, String username,
	...
	ApplicationKey getApplicationKey(String applicationId, String username, EndpointKeyType keyType)
	 ...
	 * @throws APIManagerException Erreur lors de la recherche
	 */
	SubscriptionList searchUserSubscriptions(DevPortalSubscriptionSearchCriteria devPortalSubscriptionSearchCriteria,
			String username) throws APIManagerException;

	/**
	 * Block un souscription sur une API
	 * 
	 * @param subscriptionId
	 * @throws APIManagerException
	 */
	void blockAPISubscription(String subscriptionId) throws APIManagerException;

	/**
	 * Unblock un souscription sur une API
	 * 
	 * @param subscriptionId
	 * @throws APIManagerException
	 */
	void unblockAPISubscription(String subscriptionId) throws APIManagerException;
	 ...
	 * @throws APIManagerException
	 */
	void blockUserSubscriptionsForDatasetAPIs(String username, UUID datasetUuid) throws APIManagerException;
