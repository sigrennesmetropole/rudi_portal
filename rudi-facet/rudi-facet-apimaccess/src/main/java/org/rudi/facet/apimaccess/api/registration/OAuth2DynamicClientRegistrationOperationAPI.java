...
/**
 * Lorsqu'on enregistre un utilisateur avec cette API, un nouveau rôle <code>Application/&lt;username&gt;</code> est créé dans Carbon.
 * On peut le retrouver dans WSO2 à cette URL <code>/carbon/role/role-mgt.jsp</code>.
 *
