...
public class ProviderHelper {
	...
	public ProviderHelper(
			@Value("${rudi.facet.providers.endpoint.search.url:/providers/v1/providers}") String providersEndpointSearchURL,
			@Value("${rudi.facet.providers.endpoint.get.url:/providers/v1/providers}") String providersEndpointGetURL,
			@Value("${rudi.facet.providers.endpoint.nodes.patch.url:/providers/v1/providers/{providerUuid}/nodes/{nodeUuid}}") String providersEndpointPatchNodeUrl,
			@Value("${rudi.facet.providers.service.url:lb://RUDI-PROVIDERS/}") String providersServiceURL,
		...
		this.loadBalancedWebClient = webClientBuilder.baseUrl(providersServiceURL).build();
	}
