...
VALUES ((SELECT id FROM acl_data.user WHERE login = 'konsent'), (SELECT id FROM acl_data.role WHERE code = 'MODULE')),
       ((SELECT id FROM acl_data.user WHERE login = 'konsent'),
