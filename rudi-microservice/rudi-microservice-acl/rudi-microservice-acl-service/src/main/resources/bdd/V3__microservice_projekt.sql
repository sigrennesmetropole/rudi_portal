...
( (select id from acl_data.user where login = 'projekt'), (select id from acl_data.role where code = 'MODULE')),
( (select id from acl_data.user where login = 'projekt'), (select id from acl_data.role where code = 'MODULE_PROJEKT'));
