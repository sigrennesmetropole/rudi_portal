...
public class AccountController implements AccountApi {
	...
	public ResponseEntity<Void> requestAccountCreation(@Valid @RequestBody Account account) throws AppServiceException {
	...
	@Override
	public ResponseEntity<User> validateAccount(@Valid String token) throws Exception {
