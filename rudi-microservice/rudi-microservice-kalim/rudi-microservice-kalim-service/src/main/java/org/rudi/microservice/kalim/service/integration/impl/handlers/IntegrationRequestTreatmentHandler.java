...
@Slf4j
public abstract class IntegrationRequestTreatmentHandler {
	...
	protected abstract void handleInternal(IntegrationRequestEntity integrationRequest) throws IntegrationException, DataverseAPIException, APIManagerException;
