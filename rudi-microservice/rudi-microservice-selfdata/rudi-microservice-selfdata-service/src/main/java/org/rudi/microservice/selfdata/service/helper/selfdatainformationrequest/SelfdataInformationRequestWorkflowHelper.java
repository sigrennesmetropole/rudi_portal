...
@Component
public class SelfdataInformationRequestWorkflowHelper extends AbstactAssetDescriptionHelper<SelfdataInformationRequestEntity, SelfdataInformationRequest, SelfdataInformationRequestMapper> {

	public SelfdataInformationRequestWorkflowHelper(UtilContextHelper utilContextHelper, FormHelper formHelper,
