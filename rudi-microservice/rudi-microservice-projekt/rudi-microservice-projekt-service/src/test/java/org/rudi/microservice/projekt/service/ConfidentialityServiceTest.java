...
class ConfidentialityServiceTest {
	...
	private static final ConfidentialityServiceTest.KnownConfidentiality TOP_SECRET = new ConfidentialityServiceTest.KnownConfidentiality("top-secret");
	private static final ConfidentialityServiceTest.KnownConfidentiality TOUT_PUBLIC = new ConfidentialityServiceTest.KnownConfidentiality("tout-public");
	private static final ConfidentialityServiceTest.KnownConfidentiality TEST_CREATION = new ConfidentialityServiceTest.KnownConfidentiality("test-creation");
