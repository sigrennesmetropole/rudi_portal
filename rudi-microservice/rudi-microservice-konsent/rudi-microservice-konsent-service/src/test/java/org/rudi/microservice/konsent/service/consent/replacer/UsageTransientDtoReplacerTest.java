...
@Component
public class UsageTransientDtoReplacerTest extends DictionaryEntrySetTransientDtoReplacerTest implements TransientDtoReplacerTest {
	private final DictionaryEntryMapper dictionaryEntryMapper;

	public UsageTransientDtoReplacerTest(DictionaryEntryDao dictionaryEntryDao, DictionaryEntryMapper dictionaryEntryMapper) {
	...
	public void replaceDtoFor(TreatmentVersion treatmentVersion) throws AppServiceException {
		val labelsSet = convertListToSet(dictionaryEntryMapper.dtoToEntities(treatmentVersion.getUsages()));
