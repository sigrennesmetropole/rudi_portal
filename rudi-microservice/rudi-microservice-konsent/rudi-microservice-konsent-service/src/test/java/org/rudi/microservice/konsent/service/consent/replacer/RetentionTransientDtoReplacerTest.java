...
@Component
public class RetentionTransientDtoReplacerTest extends DictionaryEntrySetTransientDtoReplacerTest implements TransientDtoReplacerTest {
	private final RetentionMapper retentionMapper;
	private final RetentionDao retentionDao;

	public RetentionTransientDtoReplacerTest(DictionaryEntryDao dictionaryEntryDao, RetentionMapper retentionMapper, RetentionDao retentionDao) {
