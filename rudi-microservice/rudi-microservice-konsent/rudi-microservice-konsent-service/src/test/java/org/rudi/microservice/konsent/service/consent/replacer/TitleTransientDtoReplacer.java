...
@Component
public class TitleTransientDtoReplacer extends DictionaryEntrySetTransientDtoReplacer implements TransientDtoReplacer {
	private final DictionaryEntryMapper dictionaryEntryMapper;

	public TitleTransientDtoReplacer(DictionaryEntryDao dictionaryEntryDao, DictionaryEntryMapper dictionaryEntryMapper) {
