...
@Component
public class DataRecipientTransientDtoTestReplacer extends DictionaryEntrySetTransientDtoReplacerTest implements TransientDtoReplacerTest {
	private final DataRecipientDao dataRecipientDao;
	private final DataRecipientMapper dataRecipientMapper;

	public DataRecipientTransientDtoTestReplacer(DictionaryEntryDao dictionaryEntryDao, DataRecipientDao dataRecipientDao, DataRecipientMapper dataRecipientMapper) {
