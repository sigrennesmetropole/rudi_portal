...
@Component
public class TypologyTreatmentTransientDtoReplacerTest extends DictionaryEntrySetTransientDtoReplacerTest implements TransientDtoReplacerTest {
	private final TypologyTreatmentMapper typologyTreatmentMapper;
	private final TypologyTreatmentDao typologyTreatmentDao;

	public TypologyTreatmentTransientDtoReplacerTest(DictionaryEntryDao dictionaryEntryDao, TypologyTreatmentMapper typologyTreatmentMapper, TypologyTreatmentDao typologyTreatmentDao) {
