...
@Component
public class TypologyTreatmentTransientDtoTestReplacer extends DictionaryEntrySetTransientDtoReplacerTest implements TransientDtoReplacerTest {
	private final TypologyTreatmentMapper typologyTreatmentMapper;
	private final TypologyTreatmentDao typologyTreatmentDao;

	public TypologyTreatmentTransientDtoTestReplacer(DictionaryEntryDao dictionaryEntryDao, TypologyTreatmentMapper typologyTreatmentMapper, TypologyTreatmentDao typologyTreatmentDao) {
