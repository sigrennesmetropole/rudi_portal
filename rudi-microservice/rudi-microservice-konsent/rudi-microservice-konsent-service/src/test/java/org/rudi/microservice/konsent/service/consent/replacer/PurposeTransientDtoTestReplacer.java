...
@Component
public class PurposeTransientDtoTestReplacer extends DictionaryEntrySetTransientDtoReplacerTest implements TransientDtoReplacerTest {
	private final PurposeMapper purposeMapper;
	private final PurposeDao purposeDao;

	public PurposeTransientDtoTestReplacer(DictionaryEntryDao dictionaryEntryDao, PurposeMapper purposeMapper, PurposeDao purposeDao) {
