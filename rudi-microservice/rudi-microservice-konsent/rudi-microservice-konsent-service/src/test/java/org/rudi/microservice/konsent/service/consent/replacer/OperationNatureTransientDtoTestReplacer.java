...
@Component
public class OperationNatureTransientDtoTestReplacer extends DictionaryEntrySetTransientDtoReplacerTest implements TransientDtoReplacerTest {
	private final DictionaryEntryMapper dictionaryEntryMapper;


	public OperationNatureTransientDtoTestReplacer(DictionaryEntryDao dictionaryEntryDao, DictionaryEntryMapper dictionaryEntryMapper) {
	...
	public void replaceDtoFor(TreatmentVersion treatmentVersion) throws AppServiceException {
		val labelsSet = convertListToSet(dictionaryEntryMapper.dtoToEntities(treatmentVersion.getOperationTreatmentNatures()));
