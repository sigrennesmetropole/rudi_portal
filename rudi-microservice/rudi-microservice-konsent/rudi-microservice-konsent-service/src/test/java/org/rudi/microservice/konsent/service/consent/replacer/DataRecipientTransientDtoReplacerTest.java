...
@Component
public class DataRecipientTransientDtoReplacerTest extends DictionaryEntrySetTransientDtoReplacerTest implements TransientDtoReplacerTest {
	private final DataRecipientDao dataRecipientDao;
	private final DataRecipientMapper dataRecipientMapper;

	public DataRecipientTransientDtoReplacerTest(DictionaryEntryDao dictionaryEntryDao, DataRecipientDao dataRecipientDao, DataRecipientMapper dataRecipientMapper) {
