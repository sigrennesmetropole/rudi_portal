...
@Component
public class RetentionTransientDtoTestReplacer extends DictionaryEntrySetTransientDtoReplacerTest implements TransientDtoReplacerTest {
	private final RetentionMapper retentionMapper;
	private final RetentionDao retentionDao;

	public RetentionTransientDtoTestReplacer(DictionaryEntryDao dictionaryEntryDao, RetentionMapper retentionMapper, RetentionDao retentionDao) {
