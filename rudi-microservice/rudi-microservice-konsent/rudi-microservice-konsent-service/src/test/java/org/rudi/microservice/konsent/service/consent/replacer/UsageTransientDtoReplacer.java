...
@Component
public class UsageTransientDtoReplacer extends DictionaryEntrySetTransientDtoReplacer implements TransientDtoReplacer {
	private final DictionaryEntryMapper dictionaryEntryMapper;

	public UsageTransientDtoReplacer(DictionaryEntryDao dictionaryEntryDao, DictionaryEntryMapper dictionaryEntryMapper) {
