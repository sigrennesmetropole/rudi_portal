...
@Component
public class PurposeTransientDtoReplacer extends DictionaryEntrySetTransientDtoReplacer implements TransientDtoReplacer {
	private final PurposeMapper purposeMapper;
	private final PurposeDao purposeDao;

	public PurposeTransientDtoReplacer(DictionaryEntryDao dictionaryEntryDao, PurposeMapper purposeMapper, PurposeDao purposeDao) {
