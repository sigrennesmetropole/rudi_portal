...
@Component
public class DataTransientDtoReplacer extends DictionaryEntrySetTransientDtoReplacer implements TransientDtoReplacer {
	private final DictionaryEntryMapper dictionaryEntryMapper;

	public DataTransientDtoReplacer(DictionaryEntryDao dictionaryEntryDao, DictionaryEntryMapper dictionaryEntryMapper) {
