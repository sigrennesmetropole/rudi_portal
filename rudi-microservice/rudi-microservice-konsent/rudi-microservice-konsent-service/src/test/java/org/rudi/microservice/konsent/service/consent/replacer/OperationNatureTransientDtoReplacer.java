...
@Component
public class OperationNatureTransientDtoReplacer extends DictionaryEntrySetTransientDtoReplacer implements TransientDtoReplacer {
	private final DictionaryEntryMapper dictionaryEntryMapper;


	public OperationNatureTransientDtoReplacer(DictionaryEntryDao dictionaryEntryDao, DictionaryEntryMapper dictionaryEntryMapper) {
