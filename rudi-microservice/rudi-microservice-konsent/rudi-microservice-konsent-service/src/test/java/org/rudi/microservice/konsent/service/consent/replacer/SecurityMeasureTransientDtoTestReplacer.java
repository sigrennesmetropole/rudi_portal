...
@Component
public class SecurityMeasureTransientDtoTestReplacer extends DictionaryEntrySetTransientDtoReplacerTest implements TransientDtoReplacerTest {
	private final SecurityMeasureDao securityMeasureDao;
	private final SecurityMeasureMapper securityMeasureMapper;

	public SecurityMeasureTransientDtoTestReplacer(DictionaryEntryDao dictionaryEntryDao, SecurityMeasureDao securityMeasureDao, SecurityMeasureMapper securityMeasureMapper) {
