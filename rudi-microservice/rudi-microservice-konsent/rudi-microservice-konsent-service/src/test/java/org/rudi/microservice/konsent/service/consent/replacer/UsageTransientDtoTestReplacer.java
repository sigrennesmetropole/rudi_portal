...
@Component
public class UsageTransientDtoTestReplacer extends DictionaryEntrySetTransientDtoReplacerTest implements TransientDtoReplacerTest {
	private final DictionaryEntryMapper dictionaryEntryMapper;

	public UsageTransientDtoTestReplacer(DictionaryEntryDao dictionaryEntryDao, DictionaryEntryMapper dictionaryEntryMapper) {
