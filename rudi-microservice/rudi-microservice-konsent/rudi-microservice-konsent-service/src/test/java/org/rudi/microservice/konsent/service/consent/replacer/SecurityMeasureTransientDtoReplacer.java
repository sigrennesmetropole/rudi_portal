...
@Component
public class SecurityMeasureTransientDtoReplacer extends DictionaryEntrySetTransientDtoReplacer implements TransientDtoReplacer {
	private final SecurityMeasureDao securityMeasureDao;
	private final SecurityMeasureMapper securityMeasureMapper;

	public SecurityMeasureTransientDtoReplacer(DictionaryEntryDao dictionaryEntryDao, SecurityMeasureDao securityMeasureDao, SecurityMeasureMapper securityMeasureMapper) {
