...
public class MonitoringAspect {
	 ...
	 */
	@Pointcut("execution(public * org.rudi.facet.dataverse.api.dataset.DatasetOperationAPI.*(..)) || execution(public * org.rudi.facet.kaccess.service.dataset.impl.DatasetServiceImpl.*(..))")
