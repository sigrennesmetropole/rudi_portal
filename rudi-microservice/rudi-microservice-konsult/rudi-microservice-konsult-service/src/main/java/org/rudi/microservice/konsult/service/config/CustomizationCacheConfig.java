...
import static org.rudi.microservice.konsult.service.constant.BeanIds.CUSTOMIZATION_RESOURCES_CACHE_MANAGER;
...
public class CustomizationCacheConfig {
	...
	@Bean(name = CUSTOMIZATION_RESOURCES_CACHE_MANAGER)
	...
	public Cache<String, DocumentContent> customizationCache(
			@Qualifier(CUSTOMIZATION_RESOURCES_CACHE_MANAGER) CacheManager cacheManager) throws AppServiceException {
