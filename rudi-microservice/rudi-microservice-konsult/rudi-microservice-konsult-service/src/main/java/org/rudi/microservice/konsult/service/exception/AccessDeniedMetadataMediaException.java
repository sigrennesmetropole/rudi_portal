...
public class AccessDeniedMetadataMediaException extends AppServiceException {
	...
	private static final long serialVersionUID = -2928325578605605563L;

	public AccessDeniedMetadataMediaException(UUID mediaId, UUID globalId) {
		super(String.format(
				"L'utilisateur connecté ne peut pas accéder au média media_id = %s du jeu de données global_id = %s",
				mediaId, globalId), AppServiceExceptionsStatus.ACCESS_DENIED_METADATA_MEDIA);
	}
}
