...
public enum AppServiceExceptionsStatus {
	...
	PASSWORD_NOT_SECURE_ENOUGH("ERROR_PASSWORD_NOT_SECURE_446", 446),
	INVALID_CREDENTIALS("INVALID_CREDENTIALS_447", 447),
	IDENTICAL_NEW_PASSWORD("IDENTICAL_NEW_PASSWORD_448", 448),
