...
@Component({
    selector: 'app-selfdata-information-request-detail',
    templateUrl: './selfdata-information-request-detail.component.html',
    styleUrls: ['./selfdata-information-request-detail.component.scss']
})
export class SelfdataInformationRequestDetailComponent
    extends TaskDetailComponent<SelfdataInformationRequest, SelfdataInformationRequestDependencies, SelfdataInformationRequestTask, SelfdataTaskSearchCriteria>
    implements OnInit {
            ...
            this.taskWithDependenciesService.getTaskWithDependencies(idTask).pipe(
                ...
                map(({task, asset, dependencies}) => {
                    return {
                        ...
                        expiredDate: moment(this.getSelfDataEndTreatmentDay(dependencies.dataset.ext_metadata.ext_selfdata.ext_selfdata_content.treatment_period, asset.updated_date)),
                    };
                })
            ).subscribe({
