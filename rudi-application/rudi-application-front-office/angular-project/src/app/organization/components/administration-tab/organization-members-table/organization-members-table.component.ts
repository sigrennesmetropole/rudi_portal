...
import {Organization, OrganizationMember, PagedOrganizationUserMembers} from '../../../../strukture/strukture-model';
import {OrganizationMetierService} from '../../../../core/services/organization/organization-metier.service';
import {OrganizationUserMember, OrganizationRole} from '../../../../strukture/api-strukture';
...
export class OrganizationMembersTableComponent implements OnInit {
    ...
    handleClickAddMember(): void {
        this.searchIsRunning = true;
        let organizationMemberDialogData: OrganizationMemberDialogData = {};
